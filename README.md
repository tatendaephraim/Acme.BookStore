...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9408efdb-7dd6-470b-8c1c-cbeb8a5f9324
```

> `9408efdb-7dd6-470b-8c1c-cbeb8a5f9324` is the password of the certificate, you can change it to any password you want.
